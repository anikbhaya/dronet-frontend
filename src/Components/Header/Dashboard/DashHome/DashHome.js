    ...
    return (
        <>
            <div className="flex justify-between">
                    <div>
                        <h4 className="text-sm font-bold text-primary">Hi Andrei,</h4>
                        <h1 className="text-4xl font-bold text-primary mt-">Welcome to Dronet!</h1>
                    </div>
                    <div>
                    ...
                    <div className="flex mt-10 space-x-10">
                        <div className="bg-white w-2/3 p-8 flex items-center justify-around rounded-xl shadow-lg">
                            <div className="space-y-2">
                                ...
                                <h1 className="text-4xl font-bold text-primary">$682.5</h1>
                            </div>
                            <div>
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-40 w-40 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor">
